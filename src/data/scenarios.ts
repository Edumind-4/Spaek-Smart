...
export const SCENARIOS: Scenario[] = [
  // TRAVEL
  {
    ...
    hints: ['Mention your return flight date', 'Know the name of your hotel']
  },
  {
    id: 'travel-hotel',
    category: 'Travel',
    ...
    hints: ['Describe the specific noise source', 'Be firm but remain respectful']
  },
  // WORKPLACE
  {
    id: 'work-raise',
    ...
    hints: ['Highlight your recent project success', 'Mention market salary averages']
  },
  {
    id: 'work-deadline',
    category: 'Workplace',
    ...
    hints: ['Take responsibility early', 'Offer a definitive new delivery date']
  },
  // SHOPPING
  {
    id: 'shopping-return',
    ...
    hints: ['Mention the consumer rights act', 'Explain why you lost the receipt']
  },
  {
    id: 'shopping-tailor',
    category: 'Shopping',
    ...
    hints: ['Specify the hem length', 'Mention the wedding date again']
  },
  // SOCIAL
  {
    id: 'social-party',
    ...
    hints: ['Ask about their connection to the host', 'Compliment the food or music']
  },
  {
    id: 'social-neighbor',
    category: 'Social',
    ...
    hints: ['Explain your early flight plans', 'Suggest a "quiet hours" agreement']
  },
  // EMERGENCIES
  {
    id: 'emergency-flat',
    ...
    hints: ['Look for nearby landmarks or street signs', 'Describe the car make and color']
  },
  {
    ...
    hints: ['List any ID or bank cards inside', 'Describe the wallet material and color']
  }
];
